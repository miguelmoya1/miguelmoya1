          ...
          <TiltCard>
            <div className="p-10 h-full flex flex-col bg-gradient-to-br from-white/5 to-white/0 backdrop-blur-xl border border-white/10 rounded-2xl group-hover:border-blue-500/30 transition-colors">
              ...
              <div className="flex flex-wrap gap-3">
                {["Angular", "Firebase", "Angular SSR", "Google Maps API"].map(
                  (tag) => (
                    <span
                      key={tag}
                      className="px-4 py-1.5 text-sm font-medium rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-300"
                    >
                      {tag}
                    </span>
                  ),
